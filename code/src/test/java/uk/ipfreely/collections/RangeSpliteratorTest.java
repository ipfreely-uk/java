...
public class RangeSpliteratorTest {
  ...
  private final Range<?>[] ranges = {
          Ranges.from(v4().fromUint(0), v4().fromUint(0)),
          Ranges.from(v4().fromUint(0), v4().fromUint(1)),
          Ranges.from(v4().fromUint(0), v4().fromUint(2)),
          Ranges.from(v4().fromUint(0), v4().fromUint(100)),
          Ranges.from(v6().fromUint(0), v6().fromUint(100)),
          Ranges.from(v4().parse("127.0.0.0"), v4().parse("127.0.0.255")),
  };
